...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Feb 2026 pada 23.58
...
(10, 61, 14, 'Proses', 'Oke', '2026-02-07 22:37:35');
...
(61, 123456, 14, 'Parkiran Motor', 'Jalanan Rusak', '2026-02-07 22:37:16');
...
INSERT INTO `siswa` (`nis`, `nama`, `kelas`, `password_hash`, `created_at`) VALUES
(567, 'Udin', 'XII BC 1', '$2y$10$q3TIHp42Q9ExQSrEuX/qQud1iwP98HhOuY6SFK9y1qOrpju7IFR5u', '2026-02-08 06:03:39'),
(987, 'Denis', 'XII RPL 1', '$2y$10$m6WavY2R1Kfh3NiTCA4eweX/UIc.gQATwiBMlNZTYboS2srIIYHra', '2026-02-08 06:03:39'),
(1001, '', 'XII RPL 1', '$2y$10$REPLACE_WITH_YOUR_HASH', '2026-02-08 06:03:39'),
(1002, '', 'XII RPL 1', '$2y$10$REPLACE_WITH_YOUR_HASH', '2026-02-08 06:03:39'),
(1003, '', 'XI IPA 2', '$2y$10$REPLACE_WITH_YOUR_HASH', '2026-02-08 06:03:39'),
(1004, '', 'XI IPS 1', '$2y$10$REPLACE_WITH_YOUR_HASH', '2026-02-08 06:03:39'),
(1005, '', 'X TKJ 1', '$2y$10$REPLACE_WITH_YOUR_HASH', '2026-02-08 06:03:39'),
(34567, '', 'XII RPL 2', '$2y$10$bTam8zSeuDVOO4AIISOnleVA0ULq4mCCcxnPPI3ecTJ8BZAH8sU/W', '2026-02-08 06:03:39'),
(123123, '', 'XI RPL 1', '$2y$10$bxwaX/jqDhiU2/Q18FV3HuM/iz4u5rZj2xFuHlXV0HJ.pBf77fcDW', '2026-02-08 06:03:39'),
(123456, 'Nuhaz', 'XII RPL 2', '$2y$10$pE9DR0VdXynIE.mA3c7T5ONFlcY7jAH.cqBGCbn3v/t9BcRjRlnCC', '2026-02-08 06:04:11');
...
--
ALTER TABLE `input_aspirasi`
  MODIFY `id_pelaporan` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
